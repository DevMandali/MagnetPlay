...
type HelloRequest struct {
	...
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // Field number 1
...
type HelloResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Message       string                 `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"` // Field number 1
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_greeter_proto_rawDesc = "" +
	...
	"\aGreeter\x129\n" +
	"\bSayHello\x12\x15.greeter.HelloRequest\x1a\x16.greeter.HelloResponseBD\n" +
	"\x18com.example.grpc.greeterB\fGreeterProtoP\x01Z\x18MagnetPlay/backend/protob\x06proto3"
